...
import com.marth7th.solidarytinker.Modifiers.battle.common.wenguanger;
...
public class solidarytinkerModifiers {
    ...
    public static final StaticModifier<wenguanger>WENGUANGER_STATIC_MODIFIER=MODIFIERS.register("wenguanger", wenguanger::new);   //战术防御
