...
public class AbsoluteJustice extends NoLevelsModifier implements  DamageBlockModifierHook, InventoryTickModifierHook , ToolDamageModifierHook {
    @Override
    protected void registerHooks(ModuleHookMap.Builder hookBuilder) {
        hookBuilder.addHook(this,ModifierHooks.DAMAGE_BLOCK,ModifierHooks.INVENTORY_TICK,ModifierHooks.TOOL_DAMAGE);
    }
